...
HTML that has meaning & is structured.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

In block the element is displayed as a block.
Inline refers to the element being displayed inside the current block targeted.
...
It allows for multiple devs to be able to make changes simultanioulsy and make pushes/changes to it remotley and allows for rollbacks in cases of code damage.
